...
1. Landing page
   ...
   - Upon visiting the site the initial page will display the game rules as well as a button "Let's Play." There is also a navigation bar, for the home page, game page, and contact page
    ...
    ![landing page](./Readmeimages/index.png)
...
1. Game Page
    ...
    ![classes page](./Readmeimages/game.png)
...
1. Navigation Bar
 ...
 This was constructed in such a way that when the screen resizes the nav bar turns into a hamburger menu:
